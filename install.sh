...
printf "\e[34m> Cloning local config repository for device \e[35m%s\e[34m...\e[0m" "$1"
git clone https://github.com/thornoar/nixos-$1-config ~/projects/nixos-local-config || exit 1
