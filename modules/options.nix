{ lib, pkgs, config, ... }:
{
    ...
    in
    {
        ...
        colorLightGrey0 = mkOpt "str" "#44475a";
        colorLightGrey1 = mkOpt "str" "#828791";
        ...
        colorBlue = mkOpt "str" "#bd93f9";
        colorBlueLight = mkOpt "str" "#6272a4";
        colorBlueP = mkOpt "str" "#61afef";
        colorCyan = mkOpt "str" "#56b6c2";
        colorGreen = mkOpt "str" "#329c48";
    ...
    config = {
        ...
        xdg.configFile."zathura/zathurarc".text = ''
            ...
            set notification-warning-fg     "${config.colorLightGrey0}" # Selection
            ...
            set completion-fg               "${config.colorBlueLight}" # Comment
            set completion-group-bg         "${config.bgColor}" # Background
            set completion-group-fg         "${config.colorBlueLight}" # Comment
            set completion-highlight-bg     "${config.colorLightGrey0}" # Selection
            ...
            set index-active-bg             "${config.colorLightGrey0}" # Current Line
        ...
        programs.alacritty = {
            ...
            settings = {
                colors.bright = {
                    black = "${config.colorLightGrey0}";
                    blue = "${config.colorBlueP}";
                ...
                colors.dim = {
                    black = "${config.bgColor}";
                    blue = "${config.colorBlueP}";
                    cyan = "${config.colorCyan}";
                    green = "${config.colorGreen}";
                    magenta = "${config.colorMagentaP}";
                    red = "${config.colorRed1}";
                    white = "${config.colorLightGrey1}";
                    yellow = "${config.colorYellow1}";
                };
                colors.normal = {
                    black = "${config.bgColor}";
