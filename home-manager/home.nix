...

{
  ...
  xdg.configFile."broot/colorscheme.hjson".text = ''
    skin: {
        default: "${config.colors.gray0} None / ${config.colors.gray1} None"
        ...
        pruning: "${config.colors.gray1} None"
        perm__: "None None"
        ...
        group: "${config.colors.gray0} None"
        count: "${config.colors.gray1} None"
        size: "${config.colors.gray1} None"
        dates: "${config.colors.gray0} None"
        ...
        git_status_ignored: "${config.colors.gray0} None"
        ...
        flag_label: "${config.colors.gray1} None"
        flag_value: "${config.colors.green5} None"
        input: "${config.colors.white2} None / ${config.colors.gray1} None"
        status_error: "${config.colors.gray0} ${config.colors.red0}"
        ...
        scrollbar_thumb: "${config.colors.gray0} None / ${config.colors.gray1} None"
        ...
        preview_title: "${config.colors.gray0} None / ${config.colors.gray1} None"
        ...
        hex_null: "${config.colors.gray1} None"
        hex_ascii_graphic: "${config.colors.gray0} None"
        ...
        staging_area_title: "${config.colors.gray0} None / ${config.colors.gray1} None"
        mode_command_mark: "${config.colors.gray0} None"
        good_to_bad_0: "#329c47"
        good_to_bad_1: "#5a9949"
        good_to_bad_2: "#76944a"
        good_to_bad_3: "#8e8f4c"
        good_to_bad_4: "#a38b4d"
        good_to_bad_5: "#b7834f"
        good_to_bad_6: "#ca7b50"
        good_to_bad_7: "#dc7052"
        good_to_bad_8: "#ee6553"
        good_to_bad_9: "#ff5555"
    }
    ext_colors: {
        txt: "${config.colors.gray0}"
