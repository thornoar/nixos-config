...
-- vim.keymap.set("n", "<PageDown>", "<C-w>h")
-- vim.keymap.set("n", "<PageUp>", "<C-w>j")
...
vim.keymap.set("n", "Z", require("nvim-boolean-toggle").toggle_boolean_or_increment)
vim.keymap.set("n", "<C-f>", function () vim.cmd("silent Focus") end)
vim.keymap.set("n", "<C-t>", function () vim.cmd("silent Twilight") end)
